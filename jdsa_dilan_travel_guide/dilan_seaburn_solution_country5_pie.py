...
first_read_country_5 = first_read[first_read.location == 'country_5'].groupby('source').count()[['user_id']]
return_reads_country_5 = return_reads[return_reads.location == 'country_5'][['user_id']]
return_reads_country_5_unique = return_reads_country_5.drop_duplicates(subset='user_id')
return_reads_country_5_unique.reset_index()
return_reads_merge = pd.merge(return_reads_country_5_unique, first_read, on = 'user_id', how = 'left')
...
first_read_values = first_read_country_5['user_id'].values
first_read_label_data = [int(x) for x in first_read_values]
first_read_label = [x for x in first_read_country_5.index]
...
results_path = 'C:\\Users\\Fru\\Desktop\\data_science_20210412\\final_task\\country_5_pie_chart_all.png'
...
mylabels = ["AdWords", "Reddit", "SEO"]
results_path = 'C:\\Users\\Fru\\Desktop\\data_science_20210412\\final_task\\country_5_pie_chart_return.png'
fig1, ax1 = plt.subplots()
