...
first_read_country_4 = first_read[first_read.location == 'country_4'].groupby('source').count()[['user_id']]
return_reads_country_4 = return_reads[return_reads.location == 'country_4'][['user_id']]
return_reads_country_4_unique = return_reads_country_4.drop_duplicates(subset='user_id')
return_reads_country_4_unique.reset_index()
return_reads_merge = pd.merge(return_reads_country_4_unique, first_read, on = 'user_id', how = 'left')
...
first_read_values = first_read_country_4['user_id'].values
first_read_label_data = [int(x) for x in first_read_values]
first_read_label = [x for x in first_read_country_4.index]
...
#This function calculate percentage values that will show on the pie chart
...
results_path = 'C:\\Users\\Fru\\Desktop\\data_science_20210412\\final_task\\country_4_pie_chart_all.png'
...
#ax1.set_title("Pie Chart - Sources of the first visitors")
plt.savefig(results_path, dpi=300)   

mylabels = ["AdWords", "Reddit", "SEO"]
results_path = 'C:\\Users\\Fru\\Desktop\\data_science_20210412\\final_task\\country_4_pie_chart_return.png'
fig1, ax1 = plt.subplots()
