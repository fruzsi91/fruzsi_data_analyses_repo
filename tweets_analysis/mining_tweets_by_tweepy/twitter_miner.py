...
class TwitterMiner:
    ...
    def data_path(self, name):
        ...
        except KeyError: # this part runs when get_tweets() function shows a key error. It means a section is ended, must change since_id and no need new_since_id and max_id.txt.
